    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Tambah Data Customers</h3>
            ...
            <?php // echo validation_errors() ?>
              <form action="" method="post">
                <div class="form-grop <?php echo form_error('kode_plg') ? 'has-error' : null?>">
                  ...
                  <input type="text" name="kode_plg" value="<?php echo set_value('kode_plg')?>" class="form-control">
                  <?php echo form_error('kode_plg')?>
                </div>
                <div class="form-group <?php echo form_error('nama_plg') ? 'has-error' : null?>">
                  <label>Nama Pelanggan *</label>
                  <input type="text" name="nama_plg" value="<?php echo set_value('nama_plg')?>" class="form-control">
                ...
                <div class="form-group <?php echo form_error('no_npwp') ? 'has-error' : null?>">
                  <label>No NPWP *</label>
                  <input type="text" name="no_npwp" value="<?php echo set_value('no_npwp')?>" class="form-control">
