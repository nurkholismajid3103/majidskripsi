    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Edit Data Ekspedisi</h3>
            ...
            <?php // echo validation_errors() ?>
              <form action="" method="post">
                <div class="form-group <?php echo form_error('id_ekspedisi') ? 'has-error' : null?>">
                  ...
                  <input type="text" name="id_ekspedisi" value="<?php echo $this->input->post('id_ekspedisi') ? $this->input->post('id_ekspedisi') : $row->id_ekspedisi?>" class="form-control">
                  <?php echo form_error('id_ekspedisi')?>
                </div>
                <div class="form-group <?php echo form_error('nama_ekspedisi') ? 'has-error' : null?>">
                  <label>Nama Ekspedisi *</label>
                  <input type="text" name="nama_ekspedisi" value="<?php echo $this->input->post('nama_ekspedisi') ? $this->input->post('nama_ekspedisi') : $row->nama_ekspedisi?>" class="form-control">
                  <?php echo form_error('nama_ekspedisi')?>
                </div>
                <div class="form-group <?php echo form_error('alamat') ? 'has-error' : null?>">
                  <label>Alamat Ekspedisi *</label><small> (Biarkan Kosong Jika Tidak diganti) </small>
