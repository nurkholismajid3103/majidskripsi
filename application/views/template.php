...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a class="logo">
      ...
      <span class="logo-lg"><b>PT.</b>TEMPO</span>
    </a>
        ...
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url()?>assets/dist/img/DSC_0065.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url()?>assets/dist/img/DSC_0065.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small><?php echo ucfirst($this->fungsi->user_login()->jabatan)?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('stok_in')?>"><i class="fa fa-circle-o"></i>Stok in</a></li>
            <li><a href="../charts/chartjs.html"><i class="fa fa-circle-o"></i>Stok Out</a></li>
          </ul> 
          </li>
          <li class="treeview"> 
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo site_url('retur')?>"><i class="fa fa-gears"></i>Barang Kadaluarsa</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a>Nurkholis Majid</a>.</strong> All rights
    reserved.
  </footer>
